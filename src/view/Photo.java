...
public class Photo extends javax.swing.JFrame {
    ...
    public void initPhoto() {
        ...
        if (Session.getAttribut("path").toString() == null) {
            JOptionPane.showMessageDialog(null, "Priere se Selectionnez Une Image ", "Info ", JOptionPane.INFORMATION_MESSAGE);

        } else {
            String path = Session.getAttribut("path").toString();
